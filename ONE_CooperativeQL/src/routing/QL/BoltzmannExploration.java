 ...
 * Acording to the policy, action <b>a</b> at state <b>s</b> is selected with
 * the next probability:</para> <code lang="none">
*                   exp( Q( s, a ) / t )
* p( s, a ) = -----------------------------
*              SUM( exp( Q( s, b ) / t ) )
*               b
* </code> <para>where <b>Q(s, a)</b> is action's <b>a</b> estimation
 * (usefulness) at state <b>s</b> and <b>t</b> is Temperature.
 * 
