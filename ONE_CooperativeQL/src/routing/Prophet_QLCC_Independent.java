 ...
 */
public abstract class Prophet_QLCC_Independent extends ActiveRouter implements CVDetectionEngine, QVDetectionEngine, TotalActionChosen {

	/** NewQLCC router's setting namespace ({@value}) */
	public static final String NewQLCC_NS = "pIQLCC";
	 ...
	 */
	public Prophet_QLCC_Independent(Settings s) {
		super(s);
	 ...
	 */
	protected Prophet_QLCC_Independent(Prophet_QLCC_Independent r) {
		super(r);
		this.ai = r.ai;
		this.md = r.md;
		this.alpha = r.alpha;
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) {
			...
			Prophet_QLCC_Independent peerRouter = (Prophet_QLCC_Independent) otherHost.getRouter();
	...
	protected void exchangemsginformation() {
		...
		for (Connection con : getConnections()) {
			...
			Prophet_QLCC_Independent other = (Prophet_QLCC_Independent) peer.getRouter();
	...
	protected double countcv(Connection con, DTNHost other) {
		Prophet_QLCC_Independent peerRouter = (Prophet_QLCC_Independent) other.getRouter();
